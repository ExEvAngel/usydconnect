...
# Pinned Posts
# Athread.create(user_id: 1, title: 'Rules' ,body: 'Before posting any threads/comments on the forum, all users must agree to abide by all the proceeding forum rules 
...
#
# thread = Athread.create(user_id: 1, title: 'Error' ,body: 'In the event of an error, please attempt the following fixes: 
# 			Refresh your browser page, 
# 			Restart your browser, 
# 			Use a different browser to verify whether the problem persists', Date: Time.now)
#
# Comment.create(user_id: 1, athread_id: thread.id, body: 'In the event that all these options fail, you may then notify one of the active moderators of the problem. 
